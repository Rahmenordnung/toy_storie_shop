function initMap() {
    ...
    var markers = locations.forEach(function(location, i) {
            ...
            content:  location.businnes || 'pok'  /*This one I don´t know how to make it itterate through all info for each town, bussines*/
        });

        var marker = new google.maps.Marker({
            position: {lat: location.lat, lng: location.lng},
            map: map,
            title: location.title || 'kuhkhi'    /*This one is working correctly for Madrid city*/
