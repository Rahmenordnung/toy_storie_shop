...
function products_per_status_dealsize(ndx) {
    ...
    stackedChart
        ...
        .xUnits(dc.units.ordinal)
        .xAxisLabel("DEALSIZE")
        .legend(dc.legend().x(275).y(0).itemHeight(15).gap(5));
...
//distribution of the prducts per regions of distribution//
...
//distribution of the prducts per country of distribution//
